...
public class Main {
	...
	public static Lista lector(String path) {
		String csvFile = path;
		String line = "";
		String cvsSplitBy = ";";
	...
	public static void alta(Lista usuarios) {
	...
	public static void busqueda(Lista usuarios){
		long inicial = System.currentTimeMillis();
	...
	public static void main(String[] args) {
		...
		Lista usuarios = lector("datasets/dataset_3000000.csv");
		//alta(usuarios);
		busqueda(usuarios);
